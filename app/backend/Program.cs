...
var azureKeyVaultEndpoint = builder.Configuration["AZURE_KEY_VAULT_ENDPOINT"]
    ?? throw new ArgumentNullException("AZURE_KEY_VAULT_ENDPOINT", "AZURE_KEY_VAULT_ENDPOINT cannot be null");

builder.Configuration.ConfigureAzureKeyVault(azureKeyVaultEndpoint);
